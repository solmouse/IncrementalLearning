...
cd IncrementalLearning/pi/cpp_pi_test_251208/
```
...
g++ tests/phase2_with_flex.cpp \
    ...
    -lpthread -ldl -lm -std=c++17 \
    -Wl,-rpath,'$ORIGIN/../lib' \
    -O3 -o tests/phase2_pi

# 실행
cd tests
export LD_LIBRARY_PATH=../lib:$LD_LIBRARY_PATH
./phase2_pi ../models/model.tflite ../models/ckpt_before.npy ../models/ckpt_after.npy
```
